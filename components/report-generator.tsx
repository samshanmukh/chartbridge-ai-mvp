...
export function ReportGenerator() {
  ...
  const handleGenerate = (type: "clinician" | "patient") => {
              ...
              <CardHeader className="pb-4 border-b bg-muted/20">
                <div className="flex items-center justify-between flex-wrap gap-3">
                  <div>
                    ...
                    <CardDescription>
                      Maria Gonzalez &middot; Diabetes Follow-up &middot; Generated by ChartBridge AI
                    </CardDescription>
                  </div>
              ...
              <CardHeader className="pb-4 border-b bg-muted/20">
                <div className="flex items-center justify-between flex-wrap gap-3">
                  <div>
                    ...
                    <CardDescription>
                      Written in plain English for Maria Gonzalez
                    </CardDescription>
                  </div>
                  <div className="flex gap-2 flex-wrap">
                    {!generated.patient && (
              ...
              <CardContent className="pt-6">
                {generating.patient ? (
                  ...
                  <div className="flex flex-col gap-3">
                    <div className="flex items-center gap-2 mb-2">
                      <CheckCircle className="size-4 text-emerald-500" />
                      <span className="text-sm font-medium text-emerald-700">Summary generated — ready to share with Maria</span>
                  ...
                  <div className="flex flex-col items-center justify-center py-16 text-center">
                    ...
                    <p className="text-xs text-muted-foreground mb-4 max-w-xs">
                      Generate a plain-English summary that empowers Maria to understand her health and advocate at her next appointment.
                    </p>
