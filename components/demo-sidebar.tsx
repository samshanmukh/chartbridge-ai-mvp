...
export function DemoSidebar({ onSectionNav }: DemoSidebarProps) {
  ...
  // Helper to get initials from a patient name
            ...
            <CardContent className="p-0">
              ...
              <div className="p-4 border-b">
                <div className="flex items-center justify-between mb-2">
                  ...
                  {!loadingSavedPatients && savedPatients.length > 0 && (
                ...
                {loadingSavedPatients ? (
                  ...
                  <div className="flex flex-col gap-1 max-h-44 overflow-y-auto pr-0.5">
                    {savedPatients.map((patient) => {
                      ...
                      const pi = getInitials(patient.name)
                      return (
                        <button
                          key={patient.id}
                        ...
                        >
                          <div
                            className={cn(
                              "flex size-7 items-center justify-center rounded-full text-[10px] font-bold shrink-0",
                              isActive
                ...
                <Button
                  variant="outline"
                  size="sm"
                  className="w-full gap-2 text-xs font-medium mt-3"
